          ...
          >
            ...
            >
              <Text
                style={{
                  fontSize: 14,
                  fontWeight: activeLocation === "Tamilnadu" ? "600" : "400",
            ...
            >
              <Text
                style={{
                  fontSize: 14,
                  fontWeight: activeLocation === "Eelam" ? "600" : "400",
...
function BskyFeedCard({ item }: { item: any }) {
  ...
  return (
    ...
    >
      {/* Header: Avatar, DisplayName, Handle, Time */}
      <View style={{ flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between" }}>
        <View style={{ flexDirection: "row", flex: 1, alignItems: "center" }}>
          {author.avatar ? (
            <Image
              source={{ uri: author.avatar }}
              style={{ width: 34, height: 34, borderRadius: 17, backgroundColor: SURFACE_ALT }}
            />
          ) : (
            <Avatar name={author.displayName || author.handle || "B"} size={34} seed={author.did || "bsky"} />
          )}
          <View style={{ marginLeft: 10, flex: 1 }}>
            <View style={{ flexDirection: "row", flexWrap: "wrap", alignItems: "center" }}>
              <Text style={{ fontSize: 13, fontWeight: "700", color: TEXT, marginRight: 4 }} numberOfLines={1}>
                {author.displayName || author.handle || "Bluesky User"}
              </Text>
        ...
        {/* Small Bluesky Logo/Indicator */}
        <View style={{ flexDirection: "row", alignItems: "center", backgroundColor: SURFACE_ALT, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4 }}>
          <Ionicons name="cloud" size={10} color={ACCENT} style={{ marginRight: 3 }} />
          <Text style={{ fontSize: 9, color: ACCENT, fontWeight: "600" }}>bsky</Text>
        </View>
      </View>
      ...
      >
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <Text style={{ fontSize: 11, color: MUTED, marginLeft: 4, fontWeight: "500" }}>
            {item.replyCount ?? 0}
          </Text>
        </View>
        ...
        {/* Reposts */}
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          <Ionicons name="repeat-outline" size={15} color={MUTED} />
          <Text style={{ fontSize: 11, color: MUTED, marginLeft: 4, fontWeight: "500" }}>
            {item.repostCount ?? 0}
          </Text>
        </View>
...
function ChatRow({
  ...
  return (
    <Pressable
      onPress={() => router.push(`/constituencies/${row.code}`)}
