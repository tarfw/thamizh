...
export default function Hub() {
  ...
  const OVERVIEW_HEIGHT = SCREEN_HEIGHT * 0.58;
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      {/* 60% Screen Height Overview Section */}
      <View
        style={{
      ...
      >
        ...
        >
          ...
          {user && (
            ...
            >
              <Avatar
                name={userProfile?.displayName ?? user.email ?? "Me"}
                size={32}
                seed={user.id}
              />
            </Pressable>
        ...
        {/* Minimal KPI Row (Issues, Pending, Residents) */}
        <View
          style={{
            flexDirection: "row",
            borderTopWidth: 1,
        ...
        >
          ...
          <View style={{ flex: 1, alignItems: "center" }}>
            ...
            <Text style={{ fontSize: 9, color: MUTED, textTransform: "uppercase", letterSpacing: 0.8, marginTop: 2, fontWeight: "600" }}>Residents</Text>
          </View>
        </View>
      </View>
      ...
      >
        ...
        {ALL_TOOLS.map((m) => (
          <Pressable
            key={m.href}
            onPress={() => router.push(`/constituencies/${code}/modules/${m.href}`)}
